            ...
            <form method="POST" action="{{ route('updatetarif', $id = $data->id) }}" id="quickForm">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" value="{{ $data->daya }}" name="daya" class="form-control" id="daya" placeholder="Masukkan Daya Listrik">
                </div>
                <div class="form-group">
                  <label for="harga">Tarif Per Kwh</label>
                  <input type="text" value="{{ $data->tarifperkwh }}" name="tarifperkwh" class="form-control" id="harga" placeholder="Masukkan Tarif Daya">
                </div>
              </div>
              <!-- /.card-body -->
